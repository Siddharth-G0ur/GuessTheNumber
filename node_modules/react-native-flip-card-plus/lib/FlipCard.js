...
import { Platform, StyleSheet, Animated,Alert,BackHandler } from "react-native";
...
class FlipCard extends Component {
  ...
  flipHorizontal(prop,ans) {
    ...
    console.log(prop.value,ans.value);

    if(count==3){
      if(prop.value==ans.value){
        Alert.alert("Alert","you Won",[
          {text: 'EXIT', onPress: () => BackHandler.exitApp()},
        ]);
      }else{ 
        Alert.alert("Alert","You lost!",[
          {text: 'EXIT', onPress: () => BackHandler.exitApp()},
        ]);
      }
    }else if(count<3){
